...
import { Specification } from '../../../services/specifications.service';
...
export class ChangeStorageComponent {
  ...
  constructor(
    ...
    const formdata = this.isNewStorage ? {
      ...
      idStorage: this.data.idStorage,
      date: this.data.date,
      quantity: this.data.quantity,
      typeOfOperation: this.data.typeOfOperation,
      specificationId: this.data.specificationId // Получаем positionid из specificationId
    };
